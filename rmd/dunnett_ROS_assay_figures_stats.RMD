...
# Color Bar Plot (Discrete)
  scale_fill_manual(values=as.vector(kelly(20))) + 
        ...
        labs(x = "Treatment", y = expression(paste("ROS, ","Fluorescence")), subtitle = paste("ANOVA:", " P"," = ", paste0(p_value, collapse = NULL))) +
...
```{r include = F}
ggsave(here("figures","ROS_assay","ROS_dunnett.jpg"), dpi = 300, width = 10, height = 8)
```
...
# Color Bar Plot (Discrete)
  scale_fill_manual(values=as.vector(kelly(20))) + 
        ...
        labs(x = "Treatment", y = expression(paste("Normalized ROS, ","Fluorescence")), subtitle = paste("ANOVA:", " P"," = ", paste0(p_value, collapse = NULL))) +
