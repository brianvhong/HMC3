...
## Combine Images
```{r}
combine_plot <- IL1B_plot + IL6_plot + TNFA_plot + APOE_plot

cowplot::plot_grid(IL1B_plot + theme(axis.title.x = element_blank(),
                                     axis.text.x = element_blank()),
                   IL6_plot + theme(axis.title.x = element_blank(),
                                    axis.text.x = element_blank(),
                                    axis.ticks.y = element_blank(),
                                    axis.title.y = element_blank()),
                   TNFA_plot,
                   APOE_plot + theme(axis.title.y = element_blank() ),
                   nrow = 2,
                   labels = "auto",
                   align = "v")
