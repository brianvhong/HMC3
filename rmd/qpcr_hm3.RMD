...
pheatmap(data_summary_df, main = expression("Gene Expression "*Log[2]*"FC"),  display_numbers = significant_heat_df,
         border_color = "black",
         number_color = "black", fontsize_number=20,
         annotation_legend = TRUE, filename = here("figures","qPCR","heatmap_new.jpg"))
```
